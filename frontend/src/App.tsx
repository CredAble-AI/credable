...
import CustomerSessionRecoveryBoundary from './components/CustomerSessionRecoveryBoundary'
...
function App() {
  return <><RouteAnnouncement /><Routes><Route path="/" element={<LandingPage />} /><Route path="/start" element={<CustomerStartPage />} /><Route element={<CustomerSessionRecoveryBoundary />}><Route path="/consent" element={<ConsentPage />} /><Route path="/data-connection" element={<DataConnectionPage />} /><Route path="/assessment" element={<AssessmentPage />} /><Route path="/evidence" element={<EvidenceSelectionPage />} /><Route path="/products" element={<ProductComparisonPage />} /><Route path="/products/:productId" element={<ProductDetailPage />} /><Route path="/products/:productId/apply" element={<ApplicationHandoffPage />} /></Route><Route path="/admin" element={<AdminShell />}><Route index element={<Navigate to="reviews" replace />} /><Route path="reviews" element={<AdminReviewListPage />} /><Route path="reviews/:reviewId" element={<AdminReviewDetailPage />} /><Route path="sessions/:sessionId/audit" element={<AdminSessionAuditPage />} /><Route path="sessions/:sessionId/evidence-burden" element={<AdminEvidenceBurdenPage />} /></Route><Route path="*" element={<NotFoundPage />} /></Routes></>
}
export default App
