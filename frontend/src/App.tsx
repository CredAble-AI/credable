    ...
    <div className="site-shell">
      ...
      <main>
        <section className="hero" id="intro"><div className="container hero__grid">
          <div className="hero__content"><p className="eyebrow">AI Credit Second-Look</p><h1>거절 뒤에 남은<br />사업의 증거를<br /><span>다시 봅니다</span></h1><p className="hero__description">CredAble은 추가 증빙을 바탕으로 거절·보류된 대출 건의 재심사 가능성을 검토하도록 돕습니다.</p><div className="hero__actions"><a className="button button--primary" href="#process">Second-Look 시작하기</a><a className="button button--secondary" href="#process">작동 방식 보기</a></div><p className="demo-note"><span aria-hidden="true">ⓘ</span> Demo Only · 최종 판단은 심사역이 수행합니다</p></div>
          <BrandScene />
        </div></section>
