...
class AuditStage(StrEnum):
    ...
    EVIDENCE_CONSENT_GRANTED = "EVIDENCE_CONSENT_GRANTED"
    EVIDENCE_CONSENT_WITHDRAWN = "EVIDENCE_CONSENT_WITHDRAWN"
    ...
    EVIDENCE_COLLECTION_RESOLVED = "EVIDENCE_COLLECTION_RESOLVED"
    ASSESSMENT_EXPLANATION_GENERATED = "ASSESSMENT_EXPLANATION_GENERATED"
    ASSESSMENT_REVIEW_REQUESTED = "ASSESSMENT_REVIEW_REQUESTED"
    UNDERWRITER_REVIEW_STARTED = "UNDERWRITER_REVIEW_STARTED"
    UNDERWRITER_REVIEW_COMPLETED = "UNDERWRITER_REVIEW_COMPLETED"
